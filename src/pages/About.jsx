...
function About() {
  ...
  return (
    <section  className="w-full h-screen ">
      <div className='w-screen h-screen bg-transparent flex justify-center items-center absolute top-0 left-0 z-10'>
      <ButtonBack></ButtonBack>
        <div  className="w-5/6 xl:w-4/6 h-min flex ">
            <div ref={projectListRef} className='text-base xl:text-xl text-center font-medium'>
            <h1 className='text-2xl xl:text-5xl font-bold mb-2 xl:mb-8'>
            ...
            <div className='contactStackBox '>
                <h2 className='text-2xl xl:text-2xl font-bold mt-8 mb-4'>Contact</h2>
                <div >
